...
- [Camera Streaming](../camera-streaming/SKILL.md) -- Resolution, frame rate, photo capture
- [MockDevice Testing](../mockdevice-testing/SKILL.md) -- Test without hardware
- [Session Lifecycle](../session-lifecycle/SKILL.md) -- Handle pause/resume/stop
- [Permissions](../permissions-registration/SKILL.md) -- Camera permission flows
